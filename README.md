...
# 功能
统计与显示今天，昨天，本周，当月的阅读时长，还可以显示本周内每天阅读时长的柱状图
...
3. 点击右上角绿色按钮，下载本仓库的zip压缩包，然后把插件（extensions）目录复制到kindle的数据目录，确保插件目录内存在kykky目录。
4. 点击“开启阅读统计”，无需重启，插件内数据可能不会及时刷新，耐心等待即可。
